...
%
%   Usage: out = cutData(data,lims)
%   Values < lims(1) are replaced with NaN.
%   Values > lims(2) are replaced with NaN.
%
%   Usage: out = cutData(data,lims,subst)
%   Values < lims(1) are replaced with the value specified by subst.
%   Values > lims(2) are replaced with the value speficied by subst.
%
